...
function geminiChatAi(userPrompt) {
    ...
    // Instruksi prompt yang diperbaiki agar AI tetap bisa menjawab pertanyaan umum yang bermanfaat
    const prompt = `
...
- Jika pertanyaan user seputar ilmu pengetahuan umum, pendidikan, atau hal bermanfaat lainnya, silakan jawab sesuai pengetahuan Anda secara ringkas dan jelas.
