...
function geminiChatAi(userPrompt) {
    ...
    // Prompt dengan instruksi tambahan agar AI memahami typo, variasi kata, dan perubahan topik
    const prompt = `
...
- Jika user melakukan typo, penambahan huruf, atau salah ketik, pahami maksud pertanyaannya dan tetap jawab dengan benar.
- Jika user tiba-tiba mengganti topik, tetap jawab sesuai topik terbaru yang ditanyakan.
...
- Jawablah dengan cara yang ramah, seperti manusia yang memahami konteks percakapan, typo, dan perubahan topik.
